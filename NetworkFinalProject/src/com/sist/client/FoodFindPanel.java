...
public class FoodFindPanel extends JPanel implements ActionListener{
	...
	public FoodFindPanel(ControllPanel cp)
	{
		...
		b1.addActionListener(this); // 버튼 클릭 시 작동
		b2.addActionListener(this); // 버튼 클릭 시 작동
		tf.addActionListener(this); // 엔터 시 작동
