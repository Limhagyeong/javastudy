 ...
 *               ---- 일반 클래스
 *               사용법) 
 *                  File file=new File("c:\\javaDev\\aa.tet");
 *                       파일 정보 읽기
 ...
 */
// -> Buffered: 임시 기억 장소 (속도가 빠르다) => 파일 읽기
import java.io.*;
// 패키지 설정 => 예외처리 (체크예외) => 컴파일러가 예외처리 여부에 대해 자동 확인
...
public class MainClass_1 {
	...
	public static void main(String[] args) {
		...
		try
		{
			...
			// InputStrem => 
			// FileInputStream => BufferedReader로 변환 (1byte => 2byte)
