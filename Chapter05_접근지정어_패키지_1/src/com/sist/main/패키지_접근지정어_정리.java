 ...
 *               => 사용 빈도가 거의 없다
 *   public : 패키지에 관계없이 모든 클래스에서 접근이 가능
 ...
 *             다른 패키지 => import 반드시 사용해서 클래스를 읽어온다
 *                         ------
 *                         라이브러리 / 사용자 정의 클래스
 ...
 *                           this.name=name
 *                        }
 *                    => 변수는 은닉화 => 메소드를 이용해서 변수 사용이 가능하도록함
 *                       ---------------------------------------------
 *                                        |
 *                                      캡슐화
 *        => 분리
