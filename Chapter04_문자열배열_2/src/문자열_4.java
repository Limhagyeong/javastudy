...
public class 문자열_4 {
	...
	public static void main(String[] args) {
        ...
        String[] title={
    	 ...
    	 // 전체 목록 출력 => 배열이 여러개 => index 이용해서 출력
...
//       {
//    	   if(max2==title[i].length())
//    	   {
//    		   break;
//    	   }
//       }
//       System.out.println("가장 긴 노래명:"+title[i]);
//       System.out.println("가장 긴 노래의 가수:"+singer[i]);
//       System.out.println("가장 긴 노래의 앨범:"+album[i]);
//       // 문자의 갯수 => length()
    	 System.out.println("=========================================================================================================================");
...
//    	 }
    	 ...
    	 System.out.println("임영웅 노래 총 갯수:"+count);
    	 System.out.println("=======================================");
    	 //검색어를 입력받아 => 검색어가 포함되어있는 노래명을 출력하시오
